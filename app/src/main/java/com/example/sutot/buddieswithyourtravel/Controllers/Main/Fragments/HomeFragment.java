...
public class HomeFragment extends android.support.v4.app.Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        refTrips = FirebaseDatabase.getInstance().getReference().child("Trips");
        refTrips.keepSynced(true);
    ...
    public void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Trips,TripViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Trips, TripViewHolder>
                (Trips.class,R.layout.card_view_trips,TripViewHolder.class,refTrips) {
            @Override
            protected void populateViewHolder(TripViewHolder viewHolder, Trips model, int position) {
                viewHolder.setTitle(model.getTitle());
                viewHolder.setInteresteds();
                viewHolder.setOwner(model.getOwnerID());
